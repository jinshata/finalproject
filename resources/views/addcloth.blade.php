...
@section('content')
<div class="col-sm-2">
<form style="margin-left: 200px;" method="POST" action="{{ URL('addcloth') }}" 
enctype="multipart/form-data">
   {{ csrf_field() }}
 
 <div class="container">
   <br><br> <h1>&nbsp;&nbsp;<font color=blue style="margin-left: 30px; font-size: 45px;">ADD CLOTH</font></h1>
...
<!-- <div class="custom-control custom-switch">
  ...
  <div class="form-group row">
      <label class="control-label col-sm-12"  for="donationitems" style="font color: black;">Cloth Category:</label>
        <div class="col-sm-4">
        <select id="selectitems" name="clothcategory" class="form-control">
        <option selected>Select Cloth</option>
                     @foreach($data as $pro_data) 
                       <option value="{{ $pro_data->clothcategory }}">
                        {{ $pro_data->clothcategory }} </option>
                      @endforeach 
                         </select>
 ...
 <div class="form-group row">
      <label class="control-label col-sm-12"  for="donationitems" style="font color: black;">Upload Cloth Image:</label>
        <div class="col-sm-4">
   ...
   <br><button type="submit" style="background-color: #ff3300; color: white; width:90px;height:40px; font-size:18px;margin-left: 35px;"  class="btn"><b>Submit</b></button>
    ...
    <td><a href="{{URL::to('viewcloth')}}" class="btn" role="button" style="width:90px;height:40px;
