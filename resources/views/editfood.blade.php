...
<div class="container">
 ...
 <form style="margin-left: 200px;" action="{{ url('update/'.$data['foodid']) }}" method="POST" enctype="multipart/form-data">
   {{ csrf_field() }}
  <!--  <input type="hidden" name="id" value="{{ $data->register_id }}">
   <input type="hidden" name="_token" value="{{ csrf_token() }}"> -->
   <div class="container">
    <h1>&nbsp;&nbsp;<font color="#f2830c" style="">UPDATE FOOD DETAILS</font></h1>
  ...
  <div class="form-group row">
    <label for="exampleInputEmail1" class="col-sm-12">FoodCategory</label>
    <div class="col-sm-4">
    <input type="text" class="form-control col-sm-4" id="exampleInputEmail1" aria-describedby="emailHelp" name="foodcategory" value="{{$data->foodcategory}}" >
    </div>
</div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="exampleInputPassword1" class="col-sm-12">Upload Food Image</label>
