...
<form style="margin-left: 10px;">
 <div class="container"> 
  ...
  <td><a href="{{ URL::to('donordetails')}}" class="btn" role="button" style="width:80px;height:40px; 
   ...
   <div class="jumbotron col-xs-12 col-lg-10 col-lg-offset-2" id="jumbotron" style="margin-left: 100px;"> 
    <h1>&nbsp;&nbsp;<font color="black" style=" margin-top: 5px;"><center>DONOR  HISTORY</center></font></h1>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
         ...
         <td><a href="{{URL::to('historyedit/'.$view_data->register_id)}}" class="btn" role="button" style="width:90px;height:40px;
            font-size:18px;background-color:#1D8311;color:white;"><b>Update</b></a></td>
            <td><a href="{{URL::to('historydelete/'.$view_data->register_id)}}" class="btn" role="button" style="width:90px;height:40px;font-size:18px;background-color:#DC071A;color:white;"><b>Delete</b></a></td>
          </td>
